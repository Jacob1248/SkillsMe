...
export const Judge = (props) =>{
    ...
    const hoverMouse = (e) =>{
        if(props.name){
            ...
            .to(elem1,{display:"block",duration:0},0)
            .to(elem2,{zIndex:"1002",duration:0},0)
            .to(elem1,{height:"fit-content",opacity:1,duration:0.2},0.1)
        }
    }
    ...
    const hoverMouseEnd = (e) =>{
        if(props.name){
            ...
            g
            .clear()
            .to(elem1,{height:"0rem",opacity:0,duration:0.2},0)
            .to(elem1,{zIndex:"0",duration:0},0.1)
